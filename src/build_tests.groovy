...
def build(product, tests_path) {
    ...
    stage('start_tests')
        ...
        C:\\python311\\python.exe -c "from uatf.run import RunTests;RunTests().run_tests()" --CREATE_REPORT_UI True --HEADLESS_MODE True --SCREEN_CAPTURE video --WORKSPACE ${WORKSPACE}
        """
