...
def build(product, tests_path) {
    ...
    stage('test_preparation') {
        ...
        def command_copy = """
        chcp 65001
        xcopy ${project_tests_path}  ${job_tests_path} /e /y /i
    ...
    stage('start_tests')
        ...
        C:\\python311\\python.exe -c "from uatf.run import RunTests;RunTests().run_tests()" --CREATE_REPORT_UI True --HEADLESS_MODE False --WORKSPACE ${WORKSPACE}
        """
